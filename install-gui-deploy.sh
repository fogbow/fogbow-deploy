...
GUI_DEPLOY_DONF_FILE_PATH="./conf-files/basic-site.conf"
...
BASIC_SITE_IP=$(grep $BASIC_SITE_IP_PATTERN $GUI_DEPLOY_DONF_FILE_PATH | awk -F "=" '{print $2}')

BASIC_SITE_PRIVATE_KEY_FILE_PATH_PATTERN="basic_site_ssh_private_key_file"
BASIC_SITE_PRIVATE_KEY_FILE_PATH=$(grep $BASIC_SITE_PRIVATE_KEY_FILE_PATH_PATTERN $GUI_DEPLOY_DONF_FILE_PATH | awk -F "=" '{print $2}')
...
REMOTE_USER=$(grep $REMOTE_USER_PATTERN $GUI_DEPLOY_DONF_FILE_PATH | awk -F "=" '{print $2}')
