...
if [ $AUTH_TYPE_CLASS == "shibboleth" ]; then
    TEMPLATE_SHIB_CONF_FILE_PATH=$CONF_FILE_TEMPLATE_DIR_PATH/"shibboleth.conf"
    ...
    sed -i "s#$DISCOVERY_SERVICE_METADATA_URL_PATTERN#$DISCOVERY_SERVICE_METADATA_URL#" $RECONFIGURATION_BASE_DIR_PATH/$SHIB_XML_FILE_NAME
    DISCOVERY_SERVICE_URL_PATTERN="_DS_"
    sed -i "s#$DISCOVERY_SERVICE_URL_PATTERN#$DISCOVERY_SERVICE_URL#" $RECONFIGURATION_BASE_DIR_PATH/$SHIB_XML_FILE_NAME
    ...
    sed -i "s#$SHIB_AUTH_APP_FOGBOW_GUI_URL_PATTERN#$SHIB_AUTH_APP_FOGBOW_GUI_URL_PATTERNhttps://$PROVIDER_ID#" $RECONFIGURATION_BASE_DIR_PATH/$SHIB_AUTHENTICATION_APPLICATION_PROPERTIES_FILE_NAME
