...
sed -i "s#.*$MANAGER_PRIVATE_KEY_PATTERN=.*#$MANAGER_PRIVATE_KEY_PATTERN=$CONTAINER_BASE_DIR/$CONTAINER_CONF_FILES_DIR/$private_key_name#" $FEDNET_CONF_FILE
sed -i "s#.*$MANAGER_PUBLIC_KEY_PATTERN=.*#$MANAGER_PUBLIC_KEY_PATTERN=$CONTAINER_BASE_DIR/$CONTAINER_CONF_FILES_DIR/$public_key_name#" $FEDNET_CONF_FILE
