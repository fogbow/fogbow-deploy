...
CERTIFICATE_FILE_PATH=$(grep $CERTIFICATE_FILE_PATTERN $CERT_CONF_FILE_NAME | awk -F "=" '{print $2}')
CERTIFICATE_FILE_NAME=$(basename $CERTIFICATE_FILE_PATH)

CERTIFICATE_KEY_FILE_PATTERN="SSL_certificate_key_file_path"
CERTIFICATE_KEY_FILE_PATH=$(grep $CERTIFICATE_KEY_FILE_PATTERN $CERT_CONF_FILE_NAME | awk -F "=" '{print $2}')
...
CERTIFICATE_CHAIN_FILE_PATH=$(grep $CERTIFICATE_CHAIN_FILE_PATTERN $CERT_CONF_FILE_NAME | awk -F "=" '{print $2}')
