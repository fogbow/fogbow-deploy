...
if [ "SHIB_PUBLIC_KEY_FILE_PATH" != "" ]; then
  ...
  ATTRIBUTE_MAP_XML_FILE="attribute-map.xml"
  yes | cp -f $BASE_CONFIGURATION_DIR/$ATTRIBUTE_MAP_XML_FILE'.example' $BASE_DIR/$ATTRIBUTE_MAP_XML_FILE
  ATTRIBUTE_POLICY_XML_FILE="attribute-policy.xml"
  yes | cp -f $BASE_CONFIGURATION_DIR/$ATTRIBUTE_POLICY_XML_FILE'.example' $BASE_DIR/$ATTRIBUTE_POLICY_XML_FILE
  INDEX_SECURE_HTML_FILE="index-secure.html"
  yes | cp -f $BASE_CONFIGURATION_DIR/$INDEX_SECURE_HTML_FILE'.example' $BASE_DIR/$INDEX_SECURE_HTML_FILE
