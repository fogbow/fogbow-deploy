...
if [ "$AUTH_TYPE_CLASS" == "shibboleth" ]; then
  ...
  SHIBBOLETH_AUTHENTICATION_APPLICATION_ADDRESS_DEFAULT_VALUE="locahost:9000"
  ...
  FOGBOW_GUI_URL_PATTERN_CONF_FILE="fogbow_gui_url"
  FOGBOW_GUI_URL=$(grep $FOGBOW_GUI_URL_PATTERN_CONF_FILE $CONF_FILES_DIR/$APACHE_CONF_FILES_DIR/$SHIBBOLETH_CONF_FILE | awk -F "=" '{print $2}')

  SHIB_PRIVATE_KEY_PATTERN_CONF_FILE="ship_private_key_path"
  SHIB_PRIVATE_KEY_PATH=$(grep $FOGBOW_GUI_URL_PATTERN_CONF_FILE $CONF_FILES_DIR/$APACHE_CONF_FILES_DIR/$SHIBBOLETH_CONF_FILE | awk -F "=" '{print $2}')
  ...
  AS_PUBLIC_KEY_PATTERN_CONF_FILE="as_public_key_path"
  AS_PUBLIC_KEY_PATH=$(grep $AS_PUBLIC_KEY_PATTERN_CONF_FILE $CONF_FILES_DIR/$APACHE_CONF_FILES_DIR/$SHIBBOLETH_CONF_FILE | awk -F "=" '{print $2}')
  AS_PUBLIC_KEY_NAME='authentication_service_public_key.pem'
  yes | cp -f $AS_PUBLIC_KEY_PATH $BASE_DIR/$AS_PUBLIC_KEY_NAME
  ...
  sed -i "s#$SHIB_AUTH_APP_FOGBOW_GUI_URL_PATTERN#$SHIB_AUTH_APP_SHIB_HTTP_PORT_PATTERN$FOGBOW_GUI_URL#" $BASE_DIR/$SHIBBOLETH_AUTHENTICATION_APPLICATION_PROPERTIES_FILE
  ...
  sed -i "s#$SHIB_AUTH_APP_AS_PUBLIC_KEY_PATTERN#$SHIB_AUTH_APP_AS_PUBLIC_KEY_PATTERN$AS_PUBLIC_KEY_NAME#" $BASE_DIR/$SHIBBOLETH_AUTHENTICATION_APPLICATION_PROPERTIES_FILE

  SHIB_AUTH_APP_SERVICE_PROVIDER_MACHINE_IP_PATTERN="service_provider_machine_ip="
  SERVICE_PROVIDER_MACHINE_IP=localhost
