...
sed -i 's/\$DASHBOARD_DOMAIN_NAME_PATTERN\b/$DASHBOARD_DOMAIN_NAME/g' $BASE_DIR/$VIRTUAL_HOST_FILE
...
sed -i 's/\$FNS_DOMAIN_NAME_PATTERN\b/$FNS_DOMAIN_NAME/g' $BASE_DIR/$VIRTUAL_HOST_FILE
...
sed -i 's/\$MS_DOMAIN_NAME_PATTERN\b/$MS_DOMAIN_NAME/g' $BASE_DIR/$VIRTUAL_HOST_FILE

# replace dashboard-basename
DASHBOARD_BASENAME=$(basename DASHBOARD_DOMAIN_NAME)
sed -i 's/\$DASHBOARD_DOMAIN_NAME_PATTERN\b/$DASHBOARD_BASENAME/g' $BASE_DIR/$VIRTUAL_HOST_FILE
# replace fns-basename
FNS_BASENAME=$(basename FNS_DOMAIN_NAME)
sed -i 's/\$FNS_DOMAIN_NAME_PATTERN\b/$FNS_BASENAME/g' $BASE_DIR/$VIRTUAL_HOST_FILE
# replace ms-basename
MS_BASENAME=$(basename MS_DOMAIN_NAME)
sed -i 's/\$MS_DOMAIN_NAME_PATTERN\b/$MS_BASENAME/g' $BASE_DIR/$VIRTUAL_HOST_FILE
