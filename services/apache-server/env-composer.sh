...
sed -i "s|$INTERNAL_HOST_IP_PATTERN|$FNS_DOMAIN_NAME|g" $BASE_DIR/$VIRTUAL_HOST_FILE
...
sed -i "s|$INTERNAL_HOST_NAME_PATTERN|$FNS_DOMAIN_BASENAME|g" $BASE_DIR/$VIRTUAL_HOST_FILE
...
GUI_PORT_PATTERN="dashboard_port"
...
sed -i "s|$INTERNAL_HOST_NAME_PATTERN|$FNS_DOMAIN_BASENAME|g" $BASE_DIR/$DOCUMENTATION_FILE
