...
mkdir -p $CONF_FILE_DIR_PATH/$APACHE_CONF_DIR_NAME
## Copy apache conf files
yes | cp -f $CONF_FILE_TEMPLATE_DIR_PATH/$APACHE_CONF_DIR_NAME/$CERT_CONF_FILE_NAME $CONF_FILE_DIR_PATH/$APACHE_CONF_DIR_NAME/$CERT_CONF_FILE_NAME
## Copy shared info
...
CERTIFICATE_FILE_PATH=$(grep $CERTIFICATE_FILE $CONF_FILE_DIR_PATH/$APACHE_CONF_DIR_NAME/$CERT_CONF_FILE_NAME | awk -F "=" '{print $2}')
CERTIFICATE_FILE_NAME=$(basename $CERTIFICATE_FILE_PATH)

CERTIFICATE_KEY_FILE="SSL_certificate_key_file_path"
CERTIFICATE_KEY_FILE_PATH=$(grep $CERTIFICATE_KEY_FILE $CONF_FILE_DIR_PATH/$APACHE_CONF_DIR_NAME/$CERT_CONF_FILE_NAME | awk -F "=" '{print $2}')
CERTIFICATE_KEY_FILE_NAME=$(basename $CERTIFICATE_KEY_FILE_PATH)

CERTIFICATE_CHAIN_FILE="SSL_certificate_chain_file_path"
CERTIFICATE_CHAIN_FILE_PATH=$(grep $CERTIFICATE_CHAIN_FILE $CONF_FILE_DIR_PATH/$APACHE_CONF_DIR_NAME/$CERT_CONF_FILE_NAME | awk -F "=" '{print $2}')
