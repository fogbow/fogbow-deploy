...
if [ "$AUTH_TYPE_CLASS" == "shibboleth" ]; then
    ...
    SHIB_AUTH_APP_CONF_FILE_NAME="shibboleth-authentication-application.conf"
    CONTAINER_SHIB_APP_FILE_DIR_PATH="/home/ubuntu/shibboleth-authentication-application

    SHIB_AUTH_APP_SHIB_PRIVATE_KEY_PATTERN="ship_private_key_path="
    sed -i "s#$SHIB_AUTH_APP_SHIB_PRIVATE_KEY_PATTERN.*#$SHIB_AUTH_APP_SHIB_PRIVATE_KEY_PATTERN$CONTAINER_SHIB_APP_FILE_DIR_PATH/$SHIB_PRIVATE_KEY_NAME#" $BASE_DIR_PATH/$SHIB_AUTH_APP_CONF_FILE_NAME
    SHIB_AUTH_APP_AS_PUBLIC_KEY_PATTERN="as_public_key_path="
    sed -i "s#$SHIB_AUTH_APP_AS_PUBLIC_KEY_PATTERN.*#$SHIB_AUTH_APP_AS_PUBLIC_KEY_PATTERN$CONTAINER_SHIB_APP_FILE_DIR_PATH/$AS_PUB_KEY_FILE_NAME#" $BASE_DIR_PATH/$SHIB_AUTH_APP_CONF_FILE_NAME
