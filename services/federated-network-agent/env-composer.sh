...
MANAGER_CONFIGURED_FILE_NAME="general.conf"
...
MANAGER_CONFIGURED_FILES_DIR=$DIR/"services"/"resource-allocation-service"/"conf-files"
MANAGER_CONFIGURED_FILE=$MANAGER_CONFIGURED_FILES_DIR/$MANAGER_CONFIGURED_FILE_NAME

MANAGER_SSH_PUBLIC_KEY_FILE_PATH_PATTERN="ras_public_key_file_path"
