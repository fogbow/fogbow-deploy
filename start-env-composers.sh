...
DATABASE_SERVICE_DIR=$SERVICES_DIR/"apache-service"
...
SERVICES_LIST="$GENERAL_CONFIGURATIONS $DATABASE_SERVICE_DIR $MANAGER_SERVICE_DIR $XMPP_SERVICE_DIR $MEMBERSHIP_SERVICE_DIR $DASHBOARD_SERVICE_DIR $FEDNET_SERVICE_DIR $FEDNET_AGENT_DIR"
