...
SERVICES_LIST="$MANAGER_SERVICE_DIR $REVERSE_TUNNEL_SERVICE_DIR $XMPP_SERVICE_DIR $MEMBERSHIP_SERVICE_DIR $DASHBOARD_SERVICE_DIR $FEDNET_SERVICE_DIR $FEDNET_AGENT_DIR"
