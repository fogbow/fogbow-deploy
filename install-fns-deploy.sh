...
VANILLA_AGENT_IP=$(grep $VANILLA_AGENT_IP_PATTERN $SITE_CONF_FILE_NAME | awk -F "=" '{print $2}')

VANILLA_AGENT_PRIVATE_KEY_FILE_PATH_PATTERN="vanilla_agent_ssh_private_key_file"
VANILLA_AGENT_PRIVATE_KEY_FILE_PATH=$(grep $VANILLA_AGENT_PRIVATE_KEY_FILE_PATH_PATTERN $SITE_CONF_FILE_NAME | awk -F "=" '{print $2}')
