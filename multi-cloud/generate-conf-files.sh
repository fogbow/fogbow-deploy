...
echo $PROVIDER_ID_PATTERN=$PROVIDER_ID >> $AS_DIR_PATH/$AS_CONF_FILE_NAME
...
echo $PROVIDER_ID_PATTERN=$PROVIDER_ID >> $RAS_DIR_PATH/$RAS_CONF_FILE_NAME
PROTOCOL="http://"
...
yes | cp -f $TEMPLATES_DIR_PATH/$AUTH"-"$GUI_CONF_FILE_NAME $GUI_DIR_PATH/$GUI_CONF_FILE_NAME
# Setting endpoints
